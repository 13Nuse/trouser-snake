...
"""
Figuring out how to use pygame

TODO:
    Remove all hardcode
    create power up items
    difficulties
    dat file for hi-score
    create classes
    fix taco position when it is at right edge and bottom
"""
...
# Game window size, game title and icon(best is 32x32px)
game_display = pygame.display.set_mode((display_width, display_height))
pygame.display.set_icon(favicon_img)
pygame.display.set_caption('Trouser Snake')

# Game fonts(style, font size) TODO: remove hardcoded font size
small_font = pygame.font.SysFont('georgia', 25)
medium_font = pygame.font.SysFont('georgia', 35)
large_font = pygame.font.SysFont('georgia', 45)
